...
public class ArtworksInRoomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if(vi == null){
            ...
            viewHolder.place_holder_1 = (TextView) vi.findViewById(R.id.artwork_place_1);
            viewHolder.place_holder_2 = (TextView) vi.findViewById(R.id.artwork_place_2);
            viewHolder.place_holder_3 = (TextView) vi.findViewById(R.id.artwork_place_3);
            viewHolder.place_holder_4 = (TextView) vi.findViewById(R.id.artwork_place_4);
            viewHolder.place_holder_5 = (TextView) vi.findViewById(R.id.artwork_place_5);
            viewHolder.place_holder_6 = (TextView) vi.findViewById(R.id.artwork_place_6);
            viewHolder.place_holder_7 = (TextView) vi.findViewById(R.id.artwork_place_7);
            viewHolder.place_holder_8 = (TextView) vi.findViewById(R.id.artwork_place_8);
            viewHolder.place_holder_9 = (TextView) vi.findViewById(R.id.artwork_place_9);
